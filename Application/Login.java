...
public class Login extends JFrame {
    ...
    private static final String REGEX = "^[\\w!#$%&'*+/=?`{|}~^-]+(?:\\.[\\w!#$%&'*+/=?`{|}~^-]+)*@(?:[a-zA-Z0-9-]+\\.)+[a-zA-Z]{2,6}$"; //email address check
    ...
    public Login() {
        ...
        fpbutton.addActionListener(new ActionListener() {
             ...
             * We check if it is correct and later come in contact with the user. */
            public void actionPerformed(ActionEvent e) {
    ...
    /* Checks if the given credentials are correct (password corresponds to school id). */
